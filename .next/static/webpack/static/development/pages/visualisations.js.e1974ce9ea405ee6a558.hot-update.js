...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(IconChart, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (_styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"] !== prevProps.fill) {
        this.updateFill();
      }
    }
  }, {
    ...
    value: function initVis() {
      ...
      this.chartArea.append("line").attr("x1", 0).attr("x2", 0).attr("y1", 0).attr("y2", 30).attr("stroke", _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"]).attr("stroke-width", 1).attr("stroke-linejoin", "round").attr("stroke-linecap", "round");
      ...
      }).attr("height", this.yScale.bandwidth()).attr("width", this.xScale(0)).attr("fill", _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"]).merge(rects).transition("in").duration(1000).delay(function (_, i) {
        return i * 250;
    ...
    value: function updateVis(data) {
      ...
      }).attr("fill", _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"]);
    }
  }, {
    key: "updateFill",
    value: function updateFill() {
      this.chartArea.selectAll("rect").attr("fill", _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"]);
      this.chartArea.select("line").attr("stroke", _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_11__["colorGrey"]);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=visualisations.js.e1974ce9ea405ee6a558.hot-update.js.map