...
var BarChart = function BarChart(_ref) {
  ...
  var createUpdateVariableText = function createUpdateVariableText() {
    ...
    texts.enter().append('text').attr('class', 'variable').attr('x', 1).attr('y', function (d) {
      ...
      return d.group;
    }).merge(texts).transition().duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_11__["easeCubicInOut"]).attr('y', function (d) {
      return yScale(d.group);
    }).attr('opacity', 1);
  };
...
//# sourceMappingURL=furniture-bank-2019.js.3358cc447e799840cf91.hot-update.js.map