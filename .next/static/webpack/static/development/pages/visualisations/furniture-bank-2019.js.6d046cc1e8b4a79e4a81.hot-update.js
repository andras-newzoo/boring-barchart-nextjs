...
})(["position:relative;display:flex;align-items:center;width:calc(100% - 4rem);height:", "px;padding:", ";margin:", ";padding-left:3rem;font-weight:", ";font-size:", ";border:1px solid ", ";border-radius:4px;background:", ";color:#fff;transition:0.5s all;&:hover div:after,&:hover div:before{visibility:visible;}"], function (props) {
...
})(["position:absolute;width:15px;left:1rem;top:50%;display:flex;justify-content:center;font-weight:", ";"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"]);
...
})(["position:absolute;top:", "rem;left:", "rem;cursor:pointer;font-weight:", ";", " color:#fff;"], function (props) {
  return props.top;
}, function (props) {
...
//# sourceMappingURL=furniture-bank-2019.js.6d046cc1e8b4a79e4a81.hot-update.js.map