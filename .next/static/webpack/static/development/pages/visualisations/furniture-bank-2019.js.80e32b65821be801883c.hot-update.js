...
})(["margin:0;padding:0;width:100vw;padding-top:5rem;display:flex;justify-content:center;align-items:center;", " ", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject()), _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject2()));
...
})(["width:90%;height:650px;max-width:1440px;display:grid;grid-template-columns:300px 1fr;grid-template-areas:\"control charts\";", " ", ""], ''
/* ${testBorder}; */
, _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject3()));
...
})(["display:grid;grid-area:control;grid-template-rows:100px 1fr;grid-template-columns:1fr;grid-template-areas:\"title\" \"panel\";padding:", ";", ""], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject4()));
...
//# sourceMappingURL=furniture-bank-2019.js.80e32b65821be801883c.hot-update.js.map