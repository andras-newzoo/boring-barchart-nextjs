...
})(["height:100%;width:100%;display:grid;grid-template-rows:20px repeat(2,1fr);grid-row-gap:1rem;grid-template-areas:\"title\" \"weight\" \"volume\";.garbage{&-month{height:45px;padding-right:2px;}&-week{height:20px;padding-right:1px;}}"]);
...
})(["display:grid;grid-area:", ";grid-template-rows:1fr 25px;grid-template-columns:repeat(2,1fr);grid-template-areas:\"num icon\" \"text text\";"], function (props) {
...
//# sourceMappingURL=furniture-bank-2019.js.1a3c5cb11dc65a831689.hot-update.js.map