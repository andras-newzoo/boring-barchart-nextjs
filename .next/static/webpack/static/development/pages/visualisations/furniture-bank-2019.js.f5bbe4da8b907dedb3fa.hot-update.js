...
/*!*****************************************************************!*\
  !*** ./containers/FurnitureBank2019/styles/styledContainers.js ***!
  \*****************************************************************/
/*! exports provided: MainContainer, DashboardContainer, ControlsContainer, LogoContainer, ControlContainer, PanelContainer, ChartsContainer, SocChartsContainer, MapContainer, FamilyContainer, PersonsContainer, ValueContainer, DonationValueContainer, EnvChartsContainer, LandFillContainer, EmissionContainer, ReqContainer */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DonationValueContainer", function() { return DonationValueContainer; });
...
})(["display:grid;grid-template-columns:80px repeat(2,1fr);grid-template-areas:\"title value percentage\";justify-items:stretch;align-items:stretch;align-self:stretch;height:100%;", ";"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"]);
var DonationValueContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "styledContainers__DonationValueContainer",
  componentId: "sc-86vxz-12"
})(["display:flex;justify-content:center;align-items:center;", ";font-size:", ";"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["fontSizeXL"]);
...
})(["display:grid;grid-area:env;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"landfill emission\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject18(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
//# sourceMappingURL=furniture-bank-2019.js.f5bbe4da8b907dedb3fa.hot-update.js.map