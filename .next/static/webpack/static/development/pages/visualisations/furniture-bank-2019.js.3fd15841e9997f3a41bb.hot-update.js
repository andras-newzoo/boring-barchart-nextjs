...
var PercentageChart = function PercentageChart(_ref) {
  ...
  var resetChart = function resetChart() {
    ...
    chartArea.select('rect').transition('toFull').duration(500).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr('width', 1); // .transition('toZero')
    // .delay(500)
    // .duration(0)
    // .attr('width', 0)
  };
...
//# sourceMappingURL=furniture-bank-2019.js.3fd15841e9997f3a41bb.hot-update.js.map