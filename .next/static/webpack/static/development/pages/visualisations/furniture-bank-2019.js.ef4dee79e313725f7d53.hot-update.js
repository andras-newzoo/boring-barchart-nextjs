...
var BarChart = function BarChart(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (init && !lodash__WEBPACK_IMPORTED_MODULE_2___default.a.isEqual(data, prevData)) {
      updateData();
    }
  ...
  initVis = function initVis() {
    ...
    var yScale = Object(d3_scale__WEBPACK_IMPORTED_MODULE_3__["scaleBand"])().range([0, dims.height]).paddingOuter(.3).paddingInner(.4);
    var xScale = Object(d3_scale__WEBPACK_IMPORTED_MODULE_3__["scaleLinear"])().range([0, dims.width]);
  ...
  updateData = function updateData() {
    ...
    xScale.domain([0, Object(d3_array__WEBPACK_IMPORTED_MODULE_5__["max"])(data, function (d) {
      return d.share;
    })]);
    storedValues.current = {
      yScale: yScale,
  ...
  var createUpdateRects = function createUpdateRects() {
    ...
    }).attr('height', yScale.bandwidth()).attr('width', 0).merge(rects).transition().duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_10__["easeCubicInOut"]).attr('width', function (d) {
...
//# sourceMappingURL=furniture-bank-2019.js.ef4dee79e313725f7d53.hot-update.js.map