...
var selectAllEmission = function selectAllEmission(state) {
  return state.furnitureBankReducer.emissionData;
};
...
var selectAllSelectedWeight = Object(reselect__WEBPACK_IMPORTED_MODULE_4__["createSelector"])(selectAllSelectedItems, selectedAllSelected, function (selectedItems, selectedQuantities) {
  return selectedItems.reduce(function (acc, curr) {
    return acc + selectedQuantities.find(function (el) {
      return curr.product_name === el.name;
    }).quantity * curr.weight_lbs;
  }, 0);
});
var selectAllSelectedVolume = Object(reselect__WEBPACK_IMPORTED_MODULE_4__["createSelector"])(selectAllSelectedItems, selectedAllSelected, function (selectedItems, selectedQuantities) {
  return selectedItems.reduce(function (acc, curr) {
    return acc + selectedQuantities.find(function (el) {
      return curr.product_name === el.name;
    }).quantity * curr.volume_ft;
  }, 0);
});
var selectAllSelectedEmission = Object(reselect__WEBPACK_IMPORTED_MODULE_4__["createSelector"])(selectedAllSelected, selectAllEmission, function (selectedItems, emissionList) {
  return selectedItems.reduce(function (acc, curr) {
    var result = emissionList.find(function (el) {
      return el.product_name.toLowerCase() === curr.name.toLowerCase;
    });
...
//# sourceMappingURL=furniture-bank-2019.js.6b95ca3d7f8ddbd0e696.hot-update.js.map