...
})(["position:absolute;width:15px;left:1rem;top:50%;transform:translateY(-50%);display:flex;justify-content:center;font-weight:", ";&:after{content:\"+\";", " position:absolute;top:-13px;left:50%;transform:translateX(-50%);cursor:pointer;}&:before{content:\"-\";position:absolute;", " transform:translateX(-50%);top:1px;left:50%;cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], ''
/* font-size: ${fontSizeS}; */
, ''
...
//# sourceMappingURL=furniture-bank-2019.js.4510ed655690e5abe5ed.hot-update.js.map