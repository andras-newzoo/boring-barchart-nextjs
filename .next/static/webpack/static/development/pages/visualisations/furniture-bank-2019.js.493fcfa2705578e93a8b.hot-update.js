...
})(["position:relative;display:flex;align-items:center;width:calc(100% - 4rem);height:", "px;padding:", ";margin:", ";padding-left:3rem;font-weight:", ";font-size:", ";border:1px solid ", ";border-radius:4px;background:", ";color:#fff;transition:.5s all;&:hover div:after,&:hover div:before{visibility:visible;}"], function (props) {
...
}, _containers_FurnitureBank2019_styles__WEBPACK_IMPORTED_MODULE_4__["colorGreyDark"]);
...
})(["position:absolute;width:15px;left:1rem;top:50%;transform:translateY(-50%);display:flex;justify-content:center;font-weight:", ";&:after{content:\"+\";", " position:absolute;top:-12px;left:50%;transform:translateX(-50%);cursor:pointer;visibility:hidden;}&:before{content:\"-\";position:absolute;", " transform:translateX(-50%);top:10px;left:50%;cursor:pointer;visibility:hidden;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], ''
/* font-size: ${fontSizeS}; */
, ''
/* font-size: ${fontSizeXS}; */
);
var ControlSpan = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].span.withConfig({
  displayName: "ItemChip__ControlSpan",
  componentId: "m9j6cq-2"
})(["position:absolute;top:", "px;left:1rem;cursor:pointer;visibility:hidden;"], function (props) {
  return props.top;
});
...
//# sourceMappingURL=furniture-bank-2019.js.493fcfa2705578e93a8b.hot-update.js.map