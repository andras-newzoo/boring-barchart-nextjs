...
})(["width:750px;height:450px;padding:", ";position:relative;display:grid;grid-row-gap:2rem;grid-column-gap:3rem;grid-template-columns:repeat(3,1fr);grid-template-rows:repeat(2,1fr);grid-template-areas:\"intro help data\" \"one three two\";img{width:100%;}.icon{position:absolute;top:.5rem;right:1rem;font-size:", ";font-weight:", ";color:", ";cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingXL"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["fontSizeL"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["fontWeightL"], _variables__WEBPACK_IMPORTED_MODULE_3__["colorRed"]);

/***/ })

})
//# sourceMappingURL=furniture-bank-2019.js.6ff0c18b13b7de2405f7.hot-update.js.map