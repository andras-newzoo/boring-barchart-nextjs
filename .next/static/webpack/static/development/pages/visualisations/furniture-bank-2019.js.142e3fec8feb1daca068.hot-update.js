...
var PercentageChart = function PercentageChart(_ref) {
  ...
  initVis = function initVis() {
    ...
    chartArea.append('rect').attr('x', 0).attr('y', 0).attr('height', dims.height + 2).attr('width', 0);
...
//# sourceMappingURL=furniture-bank-2019.js.142e3fec8feb1daca068.hot-update.js.map