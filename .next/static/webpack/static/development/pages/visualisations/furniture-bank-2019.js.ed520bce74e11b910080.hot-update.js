...
var PercentageChart = function PercentageChart(_ref) {
  ...
  resetChart = function resetChart() {
    ...
    chartArea.select("rect").transition().duration(resetDelay).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr("width", dims.width).transition().delay(resetDelay).duration(0).attr("width", 0); // updateRect()
  };
...
//# sourceMappingURL=furniture-bank-2019.js.ed520bce74e11b910080.hot-update.js.map