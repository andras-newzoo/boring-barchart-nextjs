...
})(["display:flex;align-items:center;width:calc(", "px - 1.8rem);height:", "px;padding:", ";margin:", ";padding-left:", "rem;font-weight:", ";font-size:", ";border:1px solid ", ";border-radius:4px;transition:.5s all;&:focus{outline:none;}"], function (props) {
  return props.width;
}, function (props) {
...
//# sourceMappingURL=furniture-bank-2019.js.da29699544801a193d4f.hot-update.js.map