...
/* ${testBorder}; */
, _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject3(), _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"]), _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject4(), _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"]));
...
/* ${testBorder}; */
, _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject5()));
...
/* ${testBorder}; */
, _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject6(), _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"]));
...
/* ${testBorder}; */
, _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject7()), _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject8()));
...
})(["display:grid;grid-area:soc;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr 100px;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"map families\" \"value value\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject10(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
})(["display:grid;grid-area:env;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"landfill emission\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject11(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
//# sourceMappingURL=furniture-bank-2019.js.7ba2126b00c1ff79936a.hot-update.js.map