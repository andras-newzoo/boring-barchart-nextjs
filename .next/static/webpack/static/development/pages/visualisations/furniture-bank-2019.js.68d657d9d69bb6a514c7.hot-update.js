...
/* harmony import */ var _styles_styledElements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../styles/styledElements */ "./containers/FurnitureBank2019/styles/styledElements.js");
/* harmony import */ var _mapStyles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mapStyles */ "./containers/FurnitureBank2019/components/Map/mapStyles.js");
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! .. */ "./containers/FurnitureBank2019/components/index.js");
...
var MapContent = function MapContent() {
  var filteredCoordinates = Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["useSelector"])(_store_furnitureBankReducer_selectors__WEBPACK_IMPORTED_MODULE_8__["selectFilteredCoordinates"]);
  ...
  var handleMapLoaded = function handleMapLoaded() {
    mapRef.current.getMap().addSource(_mapStyles__WEBPACK_IMPORTED_MODULE_6__["HEATMAP_SOURCE_ID"], {
      type: "geojson",
      data: makeGeoJSON(filteredCoordinates)
    });
    mapRef.current.getMap().addLayer(_mapStyles__WEBPACK_IMPORTED_MODULE_6__["heatMapStyles"]);
    setInitMap(true);
  };

  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (initMap) {
      mapRef.current.getMap().getSource(_mapStyles__WEBPACK_IMPORTED_MODULE_6__["HEATMAP_SOURCE_ID"]).setData(makeGeoJSON(filteredCoordinates));
    }
  ...
  return __jsx(_styles_styledContainers__WEBPACK_IMPORTED_MODULE_4__["MapContainer"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
    },
    __self: this
  }, __jsx(_styles_styledElements__WEBPACK_IMPORTED_MODULE_5__["ChartPaper"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 65
    },
    __self: this
  }, __jsx(_styles_styledElements__WEBPACK_IMPORTED_MODULE_5__["ChartTitle"], {
    withBG: true,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 66
    ...
    __self: this
  }, "In Which areas will your donated furniture be received?"), __jsx(___WEBPACK_IMPORTED_MODULE_10__["Message"], {
    noData: true,
    withBG: true,
    __source: {
      fileName: _jsxFileName,
    ...
    ref: mapRef,
    mapboxApiAccessToken: _config__WEBPACK_IMPORTED_MODULE_9__["config"].MAP_API
  }, viewport, {
    width: "100%",
    height: "100%",
...
//# sourceMappingURL=furniture-bank-2019.js.68d657d9d69bb6a514c7.hot-update.js.map