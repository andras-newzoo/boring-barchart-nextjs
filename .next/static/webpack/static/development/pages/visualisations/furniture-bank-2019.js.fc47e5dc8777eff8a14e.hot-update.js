...
})(["position:relative;display:flex;align-items:center;width:calc(100% - 4rem);height:", "px;padding:", ";margin:", ";padding-left:3.2rem;font-weight:", ";font-size:", ";border:1px solid ", ";border-radius:4px;background:", ";color:#fff;transition:.5s all;&:focus{outline:none;}"], function (props) {
...
})(["position:absolute;width:15px;left:1rem;top:50%;transform:translateY(-50%);display:flex;justify-content:center;font-weight:", ";&:after{content:\"+\";", " position:absolute;top:-12px;left:50%;transform:translateX(-50%);cursor:pointer;}&:before{content:\"-\";position:absolute;", " transform:translateX(-50%);top:10px;left:50%;cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], ''
/* font-size: ${fontSizeS}; */
, ''
...
//# sourceMappingURL=furniture-bank-2019.js.fc47e5dc8777eff8a14e.hot-update.js.map