...
})(["position:relative;display:flex;align-items:center;width:calc(100% - 4rem);height:", "px;padding:", ";margin:", ";padding-left:3rem;font-weight:", ";font-size:", ";border:1px solid ", ";border-radius:4px;background:", ";color:#fff;transition:.5s all;&:focus{outline:none;}"], function (props) {
...
})(["position:absolute;left:1.3rem;top:50%;transform:translateY(-50%);font-weight:", ";&:after{content:\"\u25B2\";width:10px;height:10px;font-size:", ";position:absolute;top:-12px;left:0;cursor:pointer;}&:before{content:\"\u25BC\";position:absolute;font-size:", ";top:15px;left:0;cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontSizeXS"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontSizeXS"]);
...
//# sourceMappingURL=furniture-bank-2019.js.2b39fbd6eaf4a8b9b212.hot-update.js.map