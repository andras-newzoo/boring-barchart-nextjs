...
})(["width:90%;height:650px;max-width:1440px;margin:0 auto;padding-top:4rem;padding-bottom:4rem;display:grid;grid-template-columns:300px 1fr;grid-template-areas:\"control charts\";", " ", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject()), _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject2()));
...
})(["grid-area:emission;height:100%;width:100%;display:grid;grid-template-rows:2fr 1fr;grid-template-columns:repeat(2,1fr);grid-template-areas:\"num icon\" \"text text\";"]);
