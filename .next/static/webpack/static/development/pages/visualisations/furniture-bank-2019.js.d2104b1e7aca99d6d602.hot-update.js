...
var Container = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].span.withConfig({
...
})(["display:flex;align-items:flex-end;", " font-size:", ";font-weight:", ";color:", ";line-height:", ";", ""], function (props) {
  ...
  return (props.smallSuffix || props.smallPrefix) && Object(styled_components__WEBPACK_IMPORTED_MODULE_4__["css"])([".suffix,.prefix{display:block;font-size:", ";margin-left:3px;line-height:", ";}"], props.suffixSize, props.suffixLineHeight);
});
...
var ConvertedNumber = function ConvertedNumber(_ref3) {
  var data = _ref3.data,
      ...
      _ref3$suffixLineHeigh = _ref3.suffixLineHeight,
      suffixLineHeight = _ref3$suffixLineHeigh === void 0 ? 1 : _ref3$suffixLineHeigh,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(Container, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, styles, {
    ...
    __self: this
  }, prefix, prefixSpace && " "), prefix, animate ? __jsx(react_countup__WEBPACK_IMPORTED_MODULE_3___default.a, {
    end: data,
    decimals: 3,
    preserveValue: true,
...
//# sourceMappingURL=furniture-bank-2019.js.d2104b1e7aca99d6d602.hot-update.js.map