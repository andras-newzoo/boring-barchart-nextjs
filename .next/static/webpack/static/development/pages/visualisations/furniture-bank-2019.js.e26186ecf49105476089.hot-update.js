...
var Dashboard = function Dashboard() {
  ...
  var getWeek = function getWeek(weight) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(react_helmet__WEBPACK_IMPORTED_MODULE_2__["Helmet"], {
    ...
    __self: this
  }), __jsx(_styles_styledContainers__WEBPACK_IMPORTED_MODULE_10__["LandFillSubContainer"], {
    gridArea: "weight",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 117
    ...
    __self: this
  }, !!weight && !!monthCount && _babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_0___default()(Array(Math.floor(monthCount)), function (_, i) {
    return i + 1;
  }).map(function (el) {
    return __jsx("img", {
      key: el,
  ...
  }), !!weight && !!getWeek(weight) && _babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_0___default()(Array(Math.floor(getWeek(weight))), function (_, i) {
    return i + 1;
  }).map(function (el) {
    return __jsx("img", {
      key: el,
    ...
    __self: this
  }, "2 months and 2 weeks of waste in an avg. Canadian household"))), __jsx(_styles_styledContainers__WEBPACK_IMPORTED_MODULE_10__["LandFillSubContainer"], {
    gridArea: "volume",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 166
...
//# sourceMappingURL=furniture-bank-2019.js.e26186ecf49105476089.hot-update.js.map