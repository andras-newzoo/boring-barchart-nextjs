...
var PercentageChart = function PercentageChart(_ref) {
  ...
  updateRect = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    var chartArea = storedValues.current.chartArea;
    chartArea.select("rect").transition("update").duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr("width", dims.width * (data - fullCount));
...
//# sourceMappingURL=furniture-bank-2019.js.01e3ae0768b1cf5fd857.hot-update.js.map