...
})(["position:absolute;width:15px;left:1rem;top:50%;transform:translateY(-50%);display:flex;justify-content:center;font-weight:", ";", " position:absolute;top:-12px;left:50%;transform:translateX(-50%);cursor:pointer;visibility:hidden;}&:before{content:\"-\";position:absolute;", " transform:translateX(-50%);top:10px;left:50%;cursor:pointer;visibility:hidden;}*/}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], ''
/* &:after{
content: "+";
${'' /* font-size: ${fontSizeS}; */
, ''
...
})(["position:absolute;top:", "px;left:1rem;cursor:pointer;visibility:hidden;color:#fff;"], function (props) {
  return props.top;
});
...
//# sourceMappingURL=furniture-bank-2019.js.c11f059053916ba06550.hot-update.js.map