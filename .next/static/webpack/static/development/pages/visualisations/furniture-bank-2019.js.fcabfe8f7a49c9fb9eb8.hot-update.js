...
})(["height:100%;width:100%;display:grid;grid-template-rows:20px repeat(2,1fr);grid-row-gap:1rem;grid-template-areas:\"title\" \"weight\" \"volume\";.garbage{&-month{height:45px;padding-right:2px;}&-week{height:20px;padding-right:1px;}}.container{height:50px;}"]);
...
})(["grid-area:req;display:flex;margin-top:1.6rem;justify-content:flex-end;align-items:center;.button{height:40px;cursor:pointer;transition:.3s all;&:hover{transform:translateY(-3px);}&:active{transform:translateY(0px);}}"]);

/***/ })

})
//# sourceMappingURL=furniture-bank-2019.js.fcabfe8f7a49c9fb9eb8.hot-update.js.map