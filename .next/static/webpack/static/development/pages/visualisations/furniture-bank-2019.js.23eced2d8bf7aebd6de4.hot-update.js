...
})(["grid-area:title;padding:", ";", ";img{width:100%;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingS"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"]);
...
})(["display:grid;grid-area:soc;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr 100px;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"map families\" \"value value\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject4(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
})(["display:grid;grid-area:env;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"landfill emission\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject5(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
//# sourceMappingURL=furniture-bank-2019.js.23eced2d8bf7aebd6de4.hot-update.js.map