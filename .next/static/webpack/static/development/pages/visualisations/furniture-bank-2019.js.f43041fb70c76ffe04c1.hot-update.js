...
var PercentageChart = function PercentageChart(_ref) {
  ...
  initVis = function initVis() {
    ...
    chartArea.append('rect').attr('x', 0).attr('y', 0).attr('height', chartHeight).attr('width', chartWidth / 2);
    var xScale = Object(d3_scale__WEBPACK_IMPORTED_MODULE_6__["scaleLinear"])().range([0, chartWidth]).domain([0, 1]);
...
//# sourceMappingURL=furniture-bank-2019.js.f43041fb70c76ffe04c1.hot-update.js.map