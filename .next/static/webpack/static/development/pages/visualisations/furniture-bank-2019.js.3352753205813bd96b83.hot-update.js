...
var getSuggestionValue = function getSuggestionValue(suggestion, key) {
  return "".concat(suggestion[key]);
};
...
var getSuggestions = function getSuggestions(data, key, value) {
  ...
  return data.filter(function (el) {
    return regex.test(getSuggestionValue(el[key], key));
  });
};
...
//# sourceMappingURL=furniture-bank-2019.js.3352753205813bd96b83.hot-update.js.map