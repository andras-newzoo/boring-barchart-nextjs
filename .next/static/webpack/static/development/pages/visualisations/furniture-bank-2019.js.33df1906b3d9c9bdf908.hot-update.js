...
var PercentageChart = function PercentageChart(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (init && prevData !== data) {// updateData()
    }
  ...
  updateData = function updateData() {
    ...
    chartArea.select('rect').transition().duration(1000).attr('width', dims.width * data);
  };
...
//# sourceMappingURL=furniture-bank-2019.js.33df1906b3d9c9bdf908.hot-update.js.map