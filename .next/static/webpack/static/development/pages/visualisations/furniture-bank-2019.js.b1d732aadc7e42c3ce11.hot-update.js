...
})(["width:750px;height:450px;padding:", ";position:relative;display:grid;grid-row-gap:2rem;grid-column-gap:3rem;grid-template-columns:repeat(3,1fr);grid-template-rows:repeat(2,1fr);img{width:100%;}.icon{position:absolute;top:1rem;right:1rem;font-size:", ";color:", ";cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingXL"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["fontSizeL"], _variables__WEBPACK_IMPORTED_MODULE_3__["colorRed"]);

/***/ })

})
//# sourceMappingURL=furniture-bank-2019.js.b1d732aadc7e42c3ce11.hot-update.js.map