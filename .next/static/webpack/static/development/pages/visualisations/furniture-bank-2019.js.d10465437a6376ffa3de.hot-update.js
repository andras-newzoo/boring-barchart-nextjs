...
})(["width:68px;height:", "px;background-color:", ";transform:rotate(180deg);transition:height 1s;", ""], function (props) {
  return props.height < 1 ? props.height * 41 : 41;
}, _variables__WEBPACK_IMPORTED_MODULE_3__["colorGreen"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject21(), function (props) {
...
})(["grid-area:req;display:flex;margin-top:1.6rem;justify-content:flex-end;align-items:center;.button{height:40px;cursor:pointer;transition:.3s all;&:hover{transform:translateY(-2px);}&:active{transform:translateY(0px);}}"]);

/***/ })

})
//# sourceMappingURL=furniture-bank-2019.js.d10465437a6376ffa3de.hot-update.js.map