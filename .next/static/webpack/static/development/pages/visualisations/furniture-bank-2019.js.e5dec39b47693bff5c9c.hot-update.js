...
})(["position:absolute;width:20px;left:1rem;top:50%;transform:translateY(-50%);display:flex;justify-content:center;font-weight:", ";&:after{content:\"+\";", " position:absolute;top:-13px;left:50%;transform:translateX(-50%);cursor:pointer;}&:before{content:\"-\";position:absolute;", " transform:translateX(-50%);top:12px;left:50%;cursor:pointer;}"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_3__["fontWeightXL"], ''
/* font-size: ${fontSizeS}; */
, ''
...
//# sourceMappingURL=furniture-bank-2019.js.e5dec39b47693bff5c9c.hot-update.js.map