...
var PercentageChart = function PercentageChart(_ref) {
  ...
  initVis = function initVis() {
    Object(d3_selection__WEBPACK_IMPORTED_MODULE_3__["select"])(divRef.current).append('svg').select('svg').attr('width', dims.width).attr('height', dims.height).append("g").attr("class", "chart-area");
...
//# sourceMappingURL=furniture-bank-2019.js.bcf8b74e24e65d7d65fc.hot-update.js.map