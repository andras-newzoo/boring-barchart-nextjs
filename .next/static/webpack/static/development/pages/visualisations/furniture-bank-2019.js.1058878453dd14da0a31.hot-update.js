...
var PercentageChart = function PercentageChart(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (init && prevData !== data) {
      if (prevCount !== fullCount) {
        console.log('fullcount update', data - fullCount);
      }

      updateData();
    }
  }, [data, init, prevData, updateData, fullCount, prevCount]);
  ...
  var updateRect = function updateRect(duration) {
    var chartArea = storedValues.current.chartArea;
    chartArea.select('rect').transition().duration(duration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr('width', dims.width * data);
  };
...
//# sourceMappingURL=furniture-bank-2019.js.1058878453dd14da0a31.hot-update.js.map