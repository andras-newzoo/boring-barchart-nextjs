...
var Dashboard = function Dashboard() {
  ...
  var getWeek = function getWeek(weight) {
    return Math.floor(weight / AVG_WEEKLY_WASTE);
  };
  ...
  console.log('month', getMonth(weight));
  console.log('week', getWeek(weight));
  console.log(weight);
...
//# sourceMappingURL=furniture-bank-2019.js.c054e7b19340409d8002.hot-update.js.map