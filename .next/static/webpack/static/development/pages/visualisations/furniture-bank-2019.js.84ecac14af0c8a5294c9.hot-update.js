...
})(["grid-area:req;display:flex;margin-top:1.6rem;justify-content:flex-end;align-items:center;.button{height:40px;cursor:pointer;transition:.3s all;&:hover{transform:translateY(-2px);}&:active{transform:translateY(0px);}}", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject22()));

/***/ })

})
//# sourceMappingURL=furniture-bank-2019.js.84ecac14af0c8a5294c9.hot-update.js.map