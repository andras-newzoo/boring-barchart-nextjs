...
var numberTween = function numberTween(d, i, n, format) {
  ...
  return function (t) {
    that.text("".concat(numeral__WEBPACK_IMPORTED_MODULE_2___default()(index(t)).format(format)));
  };
};
var createUpdateSvg = function createUpdateSvg(_ref) {
  var area = _ref.area,
    ...
    left: 0
      ...
      append = _ref.append;
  var container = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__["select"])(area);
  var svg = container.select("svg");
  var chartArea = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__["select"])(".chart-area");
...
//# sourceMappingURL=furniture-bank-2019.js.bf3590c3d77da125497c.hot-update.js.map