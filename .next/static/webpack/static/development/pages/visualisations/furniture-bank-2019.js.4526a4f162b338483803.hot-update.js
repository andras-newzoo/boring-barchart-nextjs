...
/*!*************************************************!*\
  !*** ./store/furnitureBankReducer/selectors.js ***!
  \*************************************************/
/*! exports provided: selectAllSelected, selectTotalQuantity, selectAllUnselected, selectAllSelectedPrice, selectAllSelectedItem, selectFilteredDonationPostalCode, selectFilteredFamilies, selectFilteredCoordinates, selectUniqueCoordinates, selectPostalCodeFamilies, selectGroups, selectTopGroups, selectAdults, selectChildren */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectAllSelectedItem", function() { return selectAllSelectedItem; });
...
var selectAllSelectedItem = Object(reselect__WEBPACK_IMPORTED_MODULE_4__["createSelector"])(selectFurnitureList, selectedAllSelected, function (furnitureList, selectedItems) {
  return selectedItems.map(function (el) {
    return +furnitureList.find(function (d) {
      return d.product_name === el.name;
    }).value;
...
//# sourceMappingURL=furniture-bank-2019.js.4526a4f162b338483803.hot-update.js.map