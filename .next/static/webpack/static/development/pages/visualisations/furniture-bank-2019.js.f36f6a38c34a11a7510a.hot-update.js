...
var PercentageChart = function PercentageChart(_ref) {
  ...
  var initVis, updateData, resetChart, updateRect;
  ...
  }, [data, init, prevData, updateData, fullCount, prevCount, resetChart, updateDuration, resetDelay, updateRect]);
  ...
  resetChart = function resetChart() {
    ...
    chartArea.select("rect").transition("toFull").duration(500).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr("width", dims.width).transition("toZero").delay(500).duration(0).attr("width", 0);
  };

  var updateDims = function updateDims() {};

  updateRect = function updateRect(_ref2) {
    var _ref2$duration = _ref2.duration,
        duration = _ref2$duration === void 0 ? updateDuration : _ref2$duration,
...
//# sourceMappingURL=furniture-bank-2019.js.f36f6a38c34a11a7510a.hot-update.js.map