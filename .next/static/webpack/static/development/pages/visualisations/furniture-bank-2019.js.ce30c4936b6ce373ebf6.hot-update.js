...
var PercentageChart = function PercentageChart(_ref) {
  ...
  initVis = function initVis() {
    ...
    chartArea.append('rect').attr('x', 0).attr('y', 0).attr('height', dims.height).attr('width', dims.width * data); // const xScale = scaleLinear().range([0, dims.width]).domain([0, 1])
...
//# sourceMappingURL=furniture-bank-2019.js.ce30c4936b6ce373ebf6.hot-update.js.map