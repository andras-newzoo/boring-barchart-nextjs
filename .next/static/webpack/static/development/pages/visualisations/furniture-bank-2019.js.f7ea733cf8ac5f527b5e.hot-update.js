...
})(["height:100%;width:100%;display:grid;grid-template-rows:25px repeat(2,1fr);grid-row-gap:1rem;grid-template-areas:\"title\" \"weight\" \"volume\";.garbage{&-month{height:40px;padding-right:2px;}&-week{height:20px;padding-bottom:1px;padding-right:1px;}}"]);
...
//# sourceMappingURL=furniture-bank-2019.js.f7ea733cf8ac5f527b5e.hot-update.js.map