...
})(["height:100%;width:100%;border-left:1px solid ", ";rect{fill:", ";}.variable{fill:", ";font-size:", " !important;}"], _styles__WEBPACK_IMPORTED_MODULE_10__["colorGrey"], _styles__WEBPACK_IMPORTED_MODULE_7__["colorGreen"], _styles__WEBPACK_IMPORTED_MODULE_10__["colorGrey"], _styles__WEBPACK_IMPORTED_MODULE_10__["fontSizeM"]);
...
var BarChart = function BarChart(_ref) {
  ...
  var createUpdateVariableText = function createUpdateVariableText() {
    ...
    texts.exit().remove();
    texts.enter().append('text').attr('x', 1).attr('y', function (d) {
      return yScale(d.group) - 1;
    }).attr('font-size', _styles__WEBPACK_IMPORTED_MODULE_10__["fontSizeS"]).text(function (d) {
      return d.group;
    });
  };
...
//# sourceMappingURL=furniture-bank-2019.js.596a057d9a1282177768.hot-update.js.map