...
/* harmony import */ var d3_format__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! d3-format */ "./node_modules/d3-format/src/index.js");
...
var BarChart = function BarChart(_ref) {
  ...
  var createUpdateValueText = function createUpdateValueText() {
    ...
    var centerText = function centerText(d) {
      return yScale(d.group) + yScale.bandwidth() / 2 + 3;
    };

    removeElement(texts);
    texts.enter().append('text').attr('class', 'value').attr('x', 0).attr('y', centerText).attr('opacity', 0).text(function (d) {
      return Object(d3_format__WEBPACK_IMPORTED_MODULE_12__["format"])('.2%')(d.share);
    }).merge(texts).transition().duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_11__["easeCubicInOut"]).attr('x', function (d) {
      return xScale(d.share) - 2;
    }).text(function (d) {
      return Object(d3_format__WEBPACK_IMPORTED_MODULE_12__["format"])('.1%')(d.share);
    }).attr('opacity', 1);
  };
...
//# sourceMappingURL=furniture-bank-2019.js.6997f119f3a1a98de271.hot-update.js.map