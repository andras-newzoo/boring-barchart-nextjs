...
var PercentageChart = function PercentageChart(_ref) {
  ...
  resetChart = function resetChart(resetPoint) {
    ...
    chartArea.select("rect").transition().duration(resetDelay).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr("width", resetPoint).transition().delay(resetDelay).duration(0).attr("width", 0).transition().delay(resetDelay * 2).duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr("width", dims.width * (data - fullCount));
  };
...
//# sourceMappingURL=furniture-bank-2019.js.27884efbe72c3afb3896.hot-update.js.map