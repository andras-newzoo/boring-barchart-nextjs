...
var PercentageChart = function PercentageChart(_ref) {
  ...
  var resetChart = function resetChart() {
    ...
    chartArea.select('rect').transition().duration(500).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).attr('width', 1).transition().duration(0).attr('width', 0);
  };
...
//# sourceMappingURL=furniture-bank-2019.js.2eb55797e076e67400db.hot-update.js.map