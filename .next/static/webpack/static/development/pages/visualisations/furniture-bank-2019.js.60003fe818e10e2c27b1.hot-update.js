...
var PercentageChart = function PercentageChart(_ref) {
  ...
  updateRect = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    ...
    var chartArea = storedValues.current.chartArea;
    chartArea.select("rect").transition("update").duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_6__["easeCubicInOut"]).delay(delay).attr("width", dims.width * (data - fullCount));
...
//# sourceMappingURL=furniture-bank-2019.js.60003fe818e10e2c27b1.hot-update.js.map