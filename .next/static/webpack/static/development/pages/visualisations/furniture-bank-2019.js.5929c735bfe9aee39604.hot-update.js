...
})(["position:relative;height:100%;width:90%;border:1px solid ", ";border-radius:20px;overflow:hidden;svg{position:absolute;rect{fill:", ";}}"], _styles__WEBPACK_IMPORTED_MODULE_4__["colorGreen"], _styles__WEBPACK_IMPORTED_MODULE_4__["colorGreen"]);
...
var PercentageChart = function PercentageChart(_ref) {
  ...
  var prevCount = Object(_hooks__WEBPACK_IMPORTED_MODULE_2__["usePrevious"])(fullCount);
  ...
  resetChart = function resetChart(resetPoint) {
    ...
    console.log('also running', updateDuration);
  ...
  updateRect = function updateRect() {
    ...
    chartArea.select("rect").attr("x", 0).attr("y", 0).attr("height", dims.height).attr("width", 0).transition("update").duration(updateDuration).ease(d3_ease__WEBPACK_IMPORTED_MODULE_5__["easeCubicInOut"]).attr("width", dims.width * (data - fullCount));
  };
...
//# sourceMappingURL=furniture-bank-2019.js.5929c735bfe9aee39604.hot-update.js.map