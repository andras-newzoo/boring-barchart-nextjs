...
})(["display:grid;grid-area:control;grid-template-rows:100px 1fr;grid-template-columns:1fr;grid-template-areas:\"title\" \"panel\";", ";padding:", ";", ""], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject3(), _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"]));
...
})(["grid-area:title;padding:", ";", ";img{width:100%;}", ""], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingS"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject4()));
...
})(["grid-area:panel;display:grid;padding:", ";", ";grid-template-rows:", " 1fr;grid-template-areas:\"title\" \"panel\";", ""], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["paddingS"], _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].medium(_templateObject5(), _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"]));
var PanelContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  ...
  return props.height;
}, _styles_sharedStyles__WEBPACK_IMPORTED_MODULE_1__["testBorder"], ""
/* ${testBorder} */
);
...
})(["display:grid;grid-area:soc;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr 100px;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"map families\" \"value value\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject7(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
})(["display:grid;grid-area:env;grid-row-gap:", ";grid-column-gap:", ";grid-template-rows:", " 1fr;grid-template-columns:repeat(2,1fr);grid-template-areas:\"title title\" \"landfill emission\";", ""], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapS"], _variables__WEBPACK_IMPORTED_MODULE_3__["gridGapM"], _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"], _variables__WEBPACK_IMPORTED_MODULE_3__["media"].small(_templateObject8(), _variables__WEBPACK_IMPORTED_MODULE_3__["titleHeightM"]));
...
//# sourceMappingURL=furniture-bank-2019.js.4d2dc8fbc23076dcbbe1.hot-update.js.map