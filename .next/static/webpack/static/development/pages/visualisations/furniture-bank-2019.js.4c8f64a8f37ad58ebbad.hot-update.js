...
var PercentageChart = function PercentageChart(_ref) {
  ...
  updateRect = function updateRect() {
    ...
    chartArea.select("rect").transition("update").duration(updateDuration).delay(500).ease(d3_ease__WEBPACK_IMPORTED_MODULE_5__["easeCubicInOut"]).attr("width", dims.width * (data - fullCount));
  };
...
//# sourceMappingURL=furniture-bank-2019.js.4c8f64a8f37ad58ebbad.hot-update.js.map